        ...
        <h4 class="title">VIỆC LÀM MỚI NHẤT</h4>
            <?php
              ...
              echo "<div class='item1'>";
                    echo "<a href='./ViecLamMoiNhat.php?nganh=KTQT'>+ Xem thêm việc làm mới nhất</a>";
                  echo "</div>";
              echo "</div>";
            }  
            ?>
            ...
            <?php
              ...
              if(mysqli_num_rows($result)>0)
              {
                ...
                while($row = mysqli_fetch_assoc($result)){
                  ...
                  echo "<div class='item1'>";
                    echo "<a href='./ViecLamCanGap.php?nganh=KTQT'>+ Xem thêm việc làm cần gấp</a>";
                  echo "</div>";
              echo "</div>";
            }
            ...
            <?php
              ...
              if(mysqli_num_rows($result)>0)
              {
                ...
                while($row = mysqli_fetch_assoc($result)){
                  ...
                  echo "<div class='item1'>";
                    echo "<a href='./ViecLamLuongCao.php?nganh=KTQT'>+ Xem thêm việc làm lương cao</a>";
                  echo "</div>";
              echo "</div>";
            }
